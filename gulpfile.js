...
gulp.task('xpiunsigned', function (cb) {
    ...
    child_process.exec('pwd && cd build/firefox/ && jpm xpi && cd ../../ && ls -la && ls -la build/firefox/ && mv build/firefox/@psonopw-*.xpi dist/firefox/psono.PW.unsigned.xpi', function (err, stdout, stderr) {
        console.log(stdout);
        console.log(stderr);
        cb(err);
    });
