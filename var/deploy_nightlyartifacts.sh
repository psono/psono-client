...
gsutil cp firefox-extension.zip gs://static.psono.com/gitlab.com/$CI_PROJECT_PATH/nightly/firefox-extension.zip && \
gsutil cp chrome-extension.zip gs://static.psono.com/gitlab.com/$CI_PROJECT_PATH/nightly/chrome-extension.zip && \
gsutil cp webclient.zip gs://static.psono.com/gitlab.com/$CI_PROJECT_PATH/nightly/webclient.zip
