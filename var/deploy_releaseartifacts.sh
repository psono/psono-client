...
gsutil cp psono.x86_64.msi gs://get.psono.com/psono/psono-client/latest/psono.x86_64.msi && \
gsutil cp psono.dmg gs://get.psono.com/psono/psono-client/latest/psono.dmg && \
...
gsutil cp psono.x86_64.msi gs://get.psono.com/psono/psono-client/$CI_COMMIT_REF_NAME/psono.x86_64.msi && \
gsutil cp psono.dmg gs://get.psono.com/psono/psono-client/$CI_COMMIT_REF_NAME/psono.dmg && \
