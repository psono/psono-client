...
describe("Service: importPasswordstateComCsv test suite", () => {
	it("importPasswordstateComCsv exists", () => {
												...
												items: [
													...
													},
													{
														...
														application_password_title:
															"Example title user2 (deployment user)",
													},
													{
														id: generic_uuid,
														type: "application_password",
														...
														application_password_notes: "",
														application_password_title:
															"Example title user (deployment user)",
													},
													{
														id: generic_uuid,
														type: "application_password",
