...
describe("Service: importNextcloudCsv test suite", () => {
	it("importNextcloudCsv exists", () => {
	...
	it("parse", () => {
		...
		const input =
			"Label,Username,Password,Notes,Url,Custom Fields,Folder,Tags,Favorite,Edited,Id,Revision,Folder Id\n" +
