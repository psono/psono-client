...
describe('Service: cryptoLibraryService test suite #1', function() {
    it('cryptoLibraryService exists', function() {
        expect(cryptoLibraryService).toBeDefined();
    });
});

describe('Service: cryptoLibraryService test suite #2', function() {
    it('cryptoLibraryService exists', function() {
        expect(cryptoLibraryService).toBeDefined();
    });

    it('cryptoLibraryService randomBytes', function() {
    ...
    */
    ...
    it('getChecksum', function() {
        return expect(cryptoLibraryService.getChecksum('RBLbEDsvgnU', 2)).toBe('4A');
    });
