...
describe('Service: importKeePassXCOrgCsv test suite', function () {

    it('importKeePassXCOrgCsv exists', function () {
    ...
    it('parse', function () {
        ...
        const input = "\"Group\",\"Title\",\"Username\",\"Password\",\"URL\",\"Notes\",\"TOTP\"\n" +
