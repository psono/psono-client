...
describe("Service: importKeePassXCOrgCsv test suite", () => {
	it("importKeePassXCOrgCsv exists", () => {
		expect(importKeePassXCOrgCsv).toBeDefined();
	});
	...
	it("parse", () => {
		...
		const input =
			...
			'"Root","home dir ","meldron","xxxx","","xxx","otpauth://totp/ACME:AzureDiamond?issuer=ACME&secret=NB2W45DFOIZA&algorithm=SHA1&digits=6&period=30"\n' +
			'"Root","CA","","xxx""xxx","","",""\n' +
		...
		const output = importKeePassXCOrgCsv.parser(input);
								...
								items: [
									{
										...
										website_password_url:
											"https://www.shellsmart.com/smart/index.htm",
					...
					},
					{
						...
						items: [
							...
							},
							{
								...
								description: "root",
								website_password_notes:
									"vSphere Client on 192.168.200.248\nfor\n192.168.200.249\n192.168.200.250",
								website_password_url: "",
							...
							},
							{
								...
								website_password_notes: "",
								website_password_url:
									"https://park.company-asd.com/path/to/login.jspx",
