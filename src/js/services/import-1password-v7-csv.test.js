...
describe("Service: import1PasswordV7Csv test suite", () => {
	it("helper exists", () => {
			...
			datastore: {
				...
				items: [
					...
					},
					{
						...
						type: "application_password",
						name: "Entry6",
						description: "username@exmaple.com",
						application_password_password: "MyUnencryptedPassword",
