		...
		callback({
			responseHeaders: {
				...
				"Content-Security-Policy": [
					"default-src 'none';  manifest-src 'self'; connect-src *; font-src 'self'; img-src 'self' data:; script-src 'self'; style-src 'self' 'unsafe-inline'; object-src 'self'; child-src 'self'",
				],
			},
		});
	});
