    ...
    event.waitUntil(
        caches.open(CACHE_VERSION).then(function(cache) {
            return cache.addAll([
                ...
                './js/controller/modal/CreateFileExchangeCtrl.js',
                ...
                './js/controller/modal/EditFileExchangeCtrl.js',
                ...
                './js/controller/OtherFileExchangeCtrl.js',
                ...
                './js/service/manager-file-exchange.js',
