...
var ClassWorkerContentScriptNotificationBar = (base, browser, setTimeout) => {
	...
	function onShowNotificationBar(data, sender, sendResponse) {
		...
		iframe.style.cssText =
			"width: 100%; height: 48px; border: 0; margin: 0; padding: 0; min-height: auto;";
		...
		wrapperDiv.style.cssText =
			"width: 100%; height: 48px; position: fixed; top: 0; left: 0; border: 0; margin: 0; padding: 0; visibility: visible; display: block; z-index: 2147483647;";
